...
const Typo1 = () => {
  ...
  useFrame(() => {
    const scrollOffset1 = scroll.range(0.298 / 1, 0.002 / 1);
    const scrollOffset2 = scroll.range(0.3 / 1, 0.002 / 1);
    const scrollOffset3 = scroll.range(0.302 / 1, 0.002 / 1);
    const scrollOffset4 = scroll.range(0.304 / 1, 0.002 / 1);
    ...
    fontSizeAni(text4.current, scrollOffset4, 0, 0.3);
  });
